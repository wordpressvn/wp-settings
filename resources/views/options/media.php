<tr valign="top" class="<?php echo $option->get_hide_class_attribute(); ?>">
    ...
    <td class="forminp forminp-text wps-media-wrapper"
        ...
        <div class="site-icon-section">
            ...
            <button class="wps-media-clear button reset" style="<?php echo empty($option->get_value_attribute()) ? 'display: none;' : ''; ?>"><?php echo $option->get_arg('button_clear_text', _e('Clear')); ?></button>
        </div>
