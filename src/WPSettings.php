        ...
        ?><script>
                (function($){
                    $('[class^="<?php echo $this->option_name; ?>"]').each(function(){
                        ...
                        children.toggleClass('hide-if-js', !parent.is(':checked'));
                    });
                    $('[name="save_license"]').click(function(event) {
                    ...
                    $('[name="license_activate"], [name="license_deactivate"]').click(function(event) {
