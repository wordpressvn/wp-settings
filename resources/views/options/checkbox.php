<tr valign="top" class="<?php echo $option->get_hide_class_attribute(); ?>">
    ...
    <td>
        <span class="components-form-toggle <?php echo $option->is_checked() ? 'is-checked' : null; ?>">
            <input name="<?php echo esc_attr($option->get_name_attribute()); ?>" id="<?php echo $option->get_id_attribute(); ?>" type="checkbox" value="<?php echo $option->get_value_attribute(); ?>" <?php echo $option->is_checked() ? 'checked' : null; ?> class="components-form-toggle__input <?php echo $option->get_input_class_attribute(); ?>">
