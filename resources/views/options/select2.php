<tr valign="top" class="<?php echo $option->get_hide_class_attribute(); ?>">
    ...
    <td>
        <select data-width="100%" id="<?php echo $option->get_id_attribute(); ?>" name="<?php echo esc_attr($option->get_name_attribute()); ?>" class="select2 <?php echo $option->get_input_class_attribute(); ?>" <?php echo ($option->get_arg('multiple') === true) ? 'multiple' : ''; ?>>
