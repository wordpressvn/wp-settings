<tr valign="top" class="<?php echo $option->get_hide_class_attribute(); ?>">
    ...
    <td>
        <input
            ...
            type="button"
            value="<?php echo $option->get_arg('type', 'button'); ?>"
            class="components-button is-primary is-compact <?php echo $option->get_input_class_attribute(); ?>">
            <span class="spinner"></span>
            <button id="stop_<?php echo $option->get_id_attribute(); ?>" type="button" class="button components-button is-compact is-tertiary <?php echo $option->get_input_class_attribute(); ?>"><span style="line-height: 30px;"  class="dashicons dashicons-controls-pause"></span><?php echo esc_html__('Pause'); ?></button>
